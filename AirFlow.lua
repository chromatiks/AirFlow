...
local function l(b, c)
    ...
    local function n(e, b, a, d, g) a._type = g a._frame = d a._listeners = a._listeners or {}
        local c = e and e.Window
        if b.Flag then
            f.Flags[b.Flag] = a
            if c then
            ...
            function a:Destroy()
                ...
                a._listeners = {}
                if b.Flag and f.Flags[b.Flag] == a then
                    f.Flags[b.Flag] = nil
                end
                if c then
                    c._controlsDirty = true
                end
                if d then
                    d:Destroy()
                end
        ...
        f.Theme = {Background = Color3.fromRGB(14, 14, 16), Surface = Color3.fromRGB(22, 22, 24), Surface2 = Color3.fromRGB(25, 25, 29), Surface3 = Color3.fromRGB(33, 33, 35), Stroke = Color3.fromRGB(30, 30, 36), StrokeHover = Color3.fromRGB(60, 60, 70), Accent = Color3.fromRGB(155, 150, 219), AccentDark = Color3.fromRGB(18, 18, 22), Text = Color3.fromRGB(255, 255, 255), Muted = Color3.fromRGB(160, 160, 165), Warning = Color3.fromRGB(240, 176, 108), Success = Color3.fromRGB(150, 220, 170), Error = Color3.fromRGB(240, 120, 120)}
        f.Assets = {Shadow = "rbxassetid://6014261993", Glow = "rbxassetid://8992230677", Logo = "rbxassetid://103859712365480"}
        local A
        local function I()
            if A ~= nil then
                return A
            end
            local b, a = pcall(function() local a = game:HttpGet "https://raw.githubusercontent.com/Footagesus/Icons/refs/heads/main/lucide/dist/Icons.lua" return loadstring(a)()
            end
            )
            if b and type(a) == "table" then
                A = a
            else
                A = false warn("[AirFlow] lucide icons unavailable: " .. tostring(a))
            end
            return A
        end
        local ae = {ValleySans = {Regular = "https://raw.githubusercontent.com/HelsinkiTypeStudio/valley-sans/main/fonts/ttf/ValleySans-Regular.ttf", Medium = "https://raw.githubusercontent.com/HelsinkiTypeStudio/valley-sans/main/fonts/ttf/ValleySans-Medium.ttf", SemiBold = "https://raw.githubusercontent.com/HelsinkiTypeStudio/valley-sans/main/fonts/ttf/ValleySans-SemiBold.ttf"}}
        local V = {Regular = {400, Enum.FontWeight.Regular}, Medium = {500, Enum.FontWeight.Medium}, SemiBold = {600, Enum.FontWeight.SemiBold}, Bold = {700, Enum.FontWeight.Bold}}
        function f:LoadFont(b)
            local e = "function" b = l(b, {})
                if type(writefile) ~= e or type(isfile) ~= e or typeof(getcustomasset) ~= e then
                    warn "[AirFlow] custom fonts need writefile, isfile and getcustomasset"
                    return false
                end
                local a = b.Name or "CustomFont"
                local g = b.Weights or ae[a]
                if type(g) ~= "table" then
                    warn("[AirFlow] no font weights for " .. a)
                    return false
                end
                local d = b.Folder or "AirFlowFonts" pcall(function() if type(isfolder) == "function" and type(makefolder) == "function" and not isfolder(d) then
                        makefolder(d)
                    end
                end
                )
                local h = {}
                for b, e in pairs(g) do
                    local c = V[b]
                    if c then
                        local f, g = d .. "/" .. a .. "-" .. b .. ".ttf", true
                        if not isfile(f) then
                            g = pcall(function() writefile(f, game:HttpGet(e))
                            end
                            )
                        end
                        if g then
                            ...
                            warn("[AirFlow] could not download " .. b .. " weight of " .. a)
                        end
                    end
                end
                if #h == 0 then
                ...
                local i = d .. "/" .. a .. ".json"
                local j = pcall(function() writefile(i, C:JSONEncode {name = a, faces = h})
                end
                )
                if not j then
                    return false
                end
                local k = getcustomasset(i)
                local function c(a, c)
                    local b = V[a]
                    if b and g[a] then
                        return Font.new(k, b[2])
                    end
                    return c
                end
                f.Fonts.Regular = c("Regular", f.Fonts.Regular) f.Fonts.Medium = c("Medium", c("Regular", f.Fonts.Medium)) f.Fonts.Bold = c("SemiBold", c("Bold", f.Fonts.Bold))
                return true
            end
            function f:PreloadIcons()
                return I() ~= false
            end
            local function af(a)
                ...
                elseif type(c) == "string" then
                    ...
                    warn("[AirFlow] unknown lucide icon: " .. d)
                    return nil
                end
                local J = "rbxasset://fonts/families/BuilderSans.json" f.Fonts = {Regular = Font.new(J, Enum.FontWeight.Regular), Medium = Font.new(J, Enum.FontWeight.Medium), Bold = Font.new(J, Enum.FontWeight.SemiBold)}
                local a = f.Theme
                local t = f.Assets
                local i = f.Fonts
                ...
                local function b(e, f, a, b, c) a = a or .2
                    ...
                    b = b or Enum.EasingStyle.Quart c = c or Enum.EasingDirection.Out
                    local g = a .. b.Name .. c.Name
                    local d = W[g]
                    if not d then
                        d = TweenInfo.new(a, b, c) W[g] = d
                    end
                    local h = T:Create(e, d, f) h:Play()
                    return h
                end
                ...
                local function h(b, d, e, f)
                    return c("UIStroke", {Color = d or a.Stroke, Transparency = e or 0, Thickness = f or 1, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Parent = b})
                end
                local function o(a, b, d, e, f)
                ...
                local function d(d)
                    local b = {BackgroundTransparency = 1, TextColor3 = a.Text, TextSize = 14, FontFace = i.Medium, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Center, TextTruncate = Enum.TextTruncate.AtEnd}
                ...
                local function u(a, c)
                    ...
                    a.Image = b a.ImageRectOffset = d or Vector2.zero a.ImageRectSize = e or Vector2.zero
                end
                local function ag()
                    local b pcall(function() if typeof(gethui) == "function" then
                            b = gethui()
                        end
                    end
                    )
                    ...
                    local a pcall(function() a = game:GetService "CoreGui" local b = Instance.new "Folder" b.Parent = a b:Destroy()
                    end
                    )
                    if a then
                        return a
                    end
                    return E:WaitForChild "PlayerGui"
                end
                local X, Y = nil, Vector2.zero
                local function r()
                    local a = time()
                    if X ~= a then
                        X = a Y = ad:GetGuiInset()
                    end
                    return q:GetMouseLocation() - Y
                end
                local function p(a)
                ...
                local function y(d, e, f, g)
                    local a = c("Frame", {AnchorPoint = Vector2.new(0, .5), Position = g, Size = UDim2.fromOffset(16, 16), BackgroundTransparency = 1, Parent = d})
                    local b = c("ImageLabel", {Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, ImageColor3 = f, ScaleType = Enum.ScaleType.Fit, Parent = a}) u(b, e)
                    return a, b
                end
                local function Z(j, g, k)
                    ...
                    local e = {}
                    local f = c("ImageLabel", {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.fromScale(.5, .5), Size = UDim2.fromOffset(16, 16), BackgroundTransparency = 1, ImageColor3 = a.Muted, ScaleType = Enum.ScaleType.Fit, Parent = h}) u(f, "chevron-down")
                    if f.Image ~= "" then
                        function e:Set(c) b(f, {Rotation = c and 180 or 0, ImageColor3 = c and a.Accent or a.Muted}, .3, Enum.EasingStyle.Quint)
                        end
                        return e
                    end
                    f:Destroy()
                    local function i(b, c)
                        return d {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.fromScale(.5, .5), Size = UDim2.fromOffset(18, 18), Text = "›", TextSize = 22, TextXAlignment = Enum.TextXAlignment.Center, TextColor3 = a.Muted, TextTransparency = c, Rotation = b, Parent = h}
                    end
                    local l = i(90, 0)
                    local m = i(270, 1)
                    function e:Set(c) b(l, {TextTransparency = c and 1 or 0}, .2) b(m, {TextTransparency = c and 0 or 1, TextColor3 = c and a.Accent or a.Muted}, .2)
                    end
                    return e
                end
                local O = {}
                local function ah(f)
                    ...
                    local d = table.remove(O)
                    if not d then
                        d = c("Frame", {AnchorPoint = Vector2.new(.5, .5), BackgroundColor3 = a.Accent, BorderSizePixel = 0}) e(d, UDim.new(1, 0))
                    end
                    d.Position = UDim2.fromOffset(g.X - f.AbsolutePosition.X, g.Y - f.AbsolutePosition.Y) d.Size = UDim2.fromOffset(0, 0) d.BackgroundTransparency = .82 d.ZIndex = f.ZIndex + 1 d.Parent = f b(d, {Size = UDim2.fromOffset(h, h), BackgroundTransparency = 1}, .55) task.delay(.55, function() d.Parent = nil if #O < 4 then
                            table.insert(O, d)
                        else
                            d:Destroy()
                        end
                ...
                local function w(c)
                    ...
                    b(c, {Color = a.Accent, Transparency = .2}, .08) task.delay(.12, function() b(c, {Color = a.Stroke, Transparency = 0}, .35)
                    end
                    )
                end
                local function F(c, d) c.MouseEnter:Connect(function() b(d, {Color = a.StrokeHover}, .12)
                end
                ) c.MouseLeave:Connect(function() b(d, {Color = a.Stroke}, .25)
                end
                )
            end
            local ai = {[Enum.KeyCode.LeftControl] = "LCtrl", [Enum.KeyCode.RightControl] = "RCtrl", [Enum.KeyCode.LeftShift] = "LShift", [Enum.KeyCode.RightShift] = "RShift", [Enum.KeyCode.LeftAlt] = "LAlt", [Enum.KeyCode.RightAlt] = "RAlt", [Enum.KeyCode.Return] = "Enter", [Enum.KeyCode.Escape] = "Esc", [Enum.KeyCode.Backspace] = "Backspace"}
            local function P(a)
                if a == nil then
                    return "None"
                end
                return ai[a] or a.Name
            end
            local function k(a, ...)
                if type(a) ~= "function" then
                        return
                    ...
                    local b, c = pcall(a, ...)
                    if not b then
                        warn("[AirFlow] callback error: " .. tostring(c))
                    end
                end
                local function aa(e, f, a)
                    local b = 0
                    local c = tostring(a)
                    local d = c:find "%."
                    if d then
                    ...
                    local g = "%." .. b .. "f"
                    return {snap =
                        function(b) b = math.floor(b / a + .5) * a
                ...
                local function G(b, f, g, c)
                    local e, h
                    if g then
                        local j = (v - 38) / 2 e = d {Position = UDim2.fromOffset(14, j), Size = UDim2.new(1, -(14 + c), 0, 18), Text = f, Parent = b}
                        h = d {Position = UDim2.fromOffset(14, j + 20), Size = UDim2.new(1, -(14 + c), 0, 17), Text = g, TextSize = 13, FontFace = i.Regular, TextColor3 = a.Muted, Parent = b}
                    else
                        e = d {Position = UDim2.fromOffset(14, 0), Size = UDim2.new(1, -(14 + c), 1, 0), Text = f, Parent = b}
                    end
                    return e, h
                end
                local function z(h, a, i, j, c, k) a = l(a, i)
                    local d = a.Desc and v or K
                    local b, e = B(h, j or "Frame", d, a) F(b, e)
                    local f, g
                    if c then
                        f, g = G(b, a.Name or k, a.Desc, c)
                    end
                    return a, b, e, d, f, g
                end
                ...
                local j = {}
                j.__index = j
                function j:_nextOrder() self._order += 1
                    return self._order
                end
                function j:Section(b)
                    ...
                    local col = self._colLeft
                    if self._colLeft and self._colRight then
                        local lh = self._colLeft.AbsoluteSize.Y
                        local rh = self._colRight.AbsoluteSize.Y
                        if rh < lh then
                            col = self._colRight
                        else
                            col = self._colLeft
                    ...
                    local card = c("Frame", {Size = UDim2.new(1, 0, 0, 0), AutomaticSize = Enum.AutomaticSize.Y, BackgroundColor3 = a.Surface, BorderSizePixel = 0, LayoutOrder = self:_nextOrder(), Parent = col or self.List})
                    e(card, UDim.new(0, 8)) h(card, a.Stroke)
                    local head = c("Frame", {Size = UDim2.new(1, 0, 0, 28), BackgroundTransparency = 1, Parent = card})
                    local e = d {Position = UDim2.fromOffset(12, 6), Size = UDim2.new(1, -24, 0, 16), Text = string.upper(tostring(b)), TextSize = 11, TextColor3 = a.Muted, TextTruncate = Enum.TextTruncate.None, Parent = head}
                    local body = c("Frame", {Position = UDim2.fromOffset(0, 28), Size = UDim2.new(1, 0, 0, 0), AutomaticSize = Enum.AutomaticSize.Y, BackgroundTransparency = 1, Parent = card})
                    c("UIListLayout", {SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 6), Parent = body})
                    o(body, 8, 8, 0, 10)
                    self.List = body
                    return n(self, {}, {Set = function(_, t) e.Text = string.upper(tostring(t))
                        end
                    }, card, "Section")
                end
                function j:Divider()
                ...
                function j:Label(b) b = l(b, {Name = "Text", Title = "Text"})
                    ...
                    if type(b.Update) == "function" then
                            local a, d = math.max(tonumber(b.UpdateRate) or 1, .05), true e._listeners = e._listeners or {}
                            table.insert(e._listeners, function() d = false
                            end
                            ) task.spawn(function() while d and c.Parent do
                                    local e, d = pcall(b.Update) if e and d ~= nil then
                                        c.Text = tostring(d)
                                    elseif not e then
                                            warn("[AirFlow] label update error: " .. tostring(d))
                                        end
                                        task.wait(a)
                                    end
                                end
                                )
                                function e:SetUpdateRate(b) a = math.max(tonumber(b) or a, .05)
                                end
                            end
                        ...
                        function j:Button(d) d = l(d, {Title = "Name", Description = "Desc"})
                            ...
                            local i, g = e and a.AccentDark or a.Text, 0
                            if d.Icon then
                                y(c, d.Icon, e and a.AccentDark or a.Accent, UDim2.new(0, 14, .5, 0)) g = 26
                            end
                            local j = G(c, d.Name or "Button", d.Desc, 30)
                            if g > 0 then
                                for b, a in ipairs(c:GetChildren()) do
                                    if a:IsA "TextLabel" then
                                        a.Position += UDim2.fromOffset(g, 0) a.Size -= UDim2.fromOffset(g, 0)
                                    end
                                end
                            end
                            if e then
                            ...
                            y(c, "chevron-right", e and a.AccentDark or a.Muted, UDim2.new(1, -30, .5, 0)) c.MouseButton1Click:Connect(function() ah(c) k(d.Callback)
                            end
                            )
                            return n(self, d, {SetText = function(b, a) j.Text = a
                                end
                            }, c, "Button")
                        end
                        function j:Toggle(f)
                            local i, o f, i, o = z(self, f, {Title = "Name", Description = "Desc", CurrentValue = "Default", Value = "Default"}, "TextButton", 56, "Toggle")
                            local g = c("Frame", {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -14, .5, 0), Size = m and UDim2.fromOffset(44, 24) or UDim2.fromOffset(36, 20), BackgroundColor3 = a.Surface3, BorderSizePixel = 0, Parent = i}) e(g, UDim.new(1, 0)) h(g, a.Stroke)
                            local j = c("Frame", {AnchorPoint = Vector2.new(0, .5), Position = UDim2.new(0, 3, .5, 0), Size = m and UDim2.fromOffset(18, 18) or UDim2.fromOffset(14, 14), BackgroundColor3 = a.Muted, BorderSizePixel = 0, Parent = g}) e(j, UDim.new(1, 0))
                            local q = c("ImageLabel", {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.fromScale(.5, .5), Size = UDim2.new(1, 24, 1, 24), BackgroundTransparency = 1, Image = t.Glow, ImageColor3 = a.Accent, ImageTransparency = 1, ZIndex = 0, Parent = g})
                            local d = {Value = f.Default == true}
                            local function p(h)
                                local e = d.Value
                                local f = h and .25 or 0 b(g, {BackgroundColor3 = e and a.Accent or a.Surface3}, f) b(q, {ImageTransparency = e and .75 or 1}, f)
                                local c = m and 18 or 14 b(j, {Position = e and UDim2.new(0, (m and 44 or 36) - 3 - c, .5, 0) or UDim2.new(0, 3, .5, 0), BackgroundColor3 = e and a.AccentDark or a.Muted}, f, Enum.EasingStyle.Back)
                                if h then
                                    b(j, {Size = UDim2.fromOffset(c + 4, c - 2)}, .08) task.delay(.08, function() b(j, {Size = UDim2.fromOffset(c, c)}, .2, Enum.EasingStyle.Back)
                                    end
                                    )
                                end
                            end
                            local l = false
                            function d:Set(a, b) a = a == true
                                if a == d.Value then
                                    return
                                end
                                d.Value = a p(true)
                            ...
                            p(false) i.MouseButton1Click:Connect(function() l = true d:Set(not d.Value) l = false
                            end
                            )
                        ...
                        function j:Slider(g)
                            local C = "Frame" g = l(g, {Title = "Name", Description = "Desc", CurrentValue = "Default", Value = "Default", Increment = "Step"})
                            local o = g.Min or 0
                            local D = g.Max or 100
                            local V = g.Step or 1
                            local I = g.Suffix or ""
                            local J = aa(o, D, V)
                            local y, Q = B(self, C, v, g) F(y, Q) d {Position = UDim2.fromOffset(14, 12), Size = UDim2.new(1, -120, 0, 18), Text = g.Name or "Slider", Parent = y}
                            local q = c(C, {AnchorPoint = Vector2.new(1, 0), Position = UDim2.new(1, -10, 0, 9), Size = UDim2.fromOffset(40, 24), BackgroundColor3 = a.Surface, BorderSizePixel = 0, ClipsDescendants = true, Parent = y}) e(q, UDim.new(0, 6))
                            local K = h(q)
                            local z = d {Size = UDim2.new(1, 0, 1, 0), TextSize = 13, TextColor3 = a.Accent, TextXAlignment = Enum.TextXAlignment.Center, TextTruncate = Enum.TextTruncate.None, Parent = q}
                            local j = c("TextBox", {Position = UDim2.fromOffset(9, 0), Size = UDim2.new(0, 0, 1, 0), AutomaticSize = Enum.AutomaticSize.X, BackgroundTransparency = 1, Text = "", TextColor3 = a.Text, TextSize = 13, FontFace = i.Medium, TextXAlignment = Enum.TextXAlignment.Left, ClearTextOnFocus = false, Visible = false, Parent = q}) c("UISizeConstraint", {MinSize = Vector2.new(14, 0), Parent = j})
                            local L = d {Size = UDim2.new(0, 0, 1, 0), AutomaticSize = Enum.AutomaticSize.X, Text = I, TextSize = 13, TextColor3 = a.Accent, TextTruncate = Enum.TextTruncate.None, Visible = false, Parent = q}
                            local E, G = c("TextButton", {Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Text = "", AutoButtonColor = false, ZIndex = 2, Parent = q}), false
                            local function H(c)
                                local a
                                if G then
                                    a = 9 + j.AbsoluteSize.X / self.Window.Scale.Scale + L.TextBounds.X + 9 L.Position = UDim2.fromOffset(9 + j.AbsoluteSize.X / self.Window.Scale.Scale, 0)
                                else
                                    a = z.TextBounds.X + 18
                                end
                                a = math.max(a, 36)
                                if c then
                                    q.Size = UDim2.fromOffset(a, 24)
                                else
                                    b(q, {Size = UDim2.fromOffset(a, 24)}, .2)
                                end
                            end
                            z:GetPropertyChangedSignal "TextBounds":Connect(function() if not G then
                                    H(false)
                                end
                            end
                            ) j:GetPropertyChangedSignal "AbsoluteSize":Connect(function() if G then
                                    H(false)
                                end
                            end
                            )
                            local u = c(C, {Position = UDim2.new(0, 14, 0, v - 18), Size = UDim2.new(1, -28, 0, 5), BackgroundColor3 = a.Surface3, BorderSizePixel = 0, Parent = y}) e(u, UDim.new(1, 0))
                            local R = c(C, {Size = UDim2.new(0, 0, 1, 0), BackgroundColor3 = a.Accent, BorderSizePixel = 0, Parent = u}) e(R, UDim.new(1, 0))
                            local x = c("ImageLabel", {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.new(0, 0, .5, 0), Size = UDim2.fromOffset(28, 28), BackgroundTransparency = 1, Image = t.Glow, ImageColor3 = a.Accent, ImageTransparency = .85, ZIndex = 2, Parent = u})
                            local A = c(C, {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.new(0, 0, .5, 0), Size = UDim2.fromOffset(12, 12), BackgroundColor3 = a.Accent, BorderSizePixel = 0, ZIndex = 3, Parent = u}) e(A, UDim.new(1, 0))
                            local O = c("TextButton", {Position = UDim2.new(0, 8, 0, v - (m and 37 or 31)), Size = UDim2.new(1, -16, 0, m and 40 or 28), BackgroundTransparency = 1, Text = "", AutoButtonColor = false, ZIndex = 4, Parent = y})
                            local f, s = {Value = math.clamp(g.Default or o, o, D)}, false E.MouseEnter:Connect(function() b(K, {Color = a.StrokeHover}, .12)
                            end
                            ) E.MouseLeave:Connect(function() if not j:IsFocused() then
                                    b(K, {Color = a.Stroke}, .2)
                                end
                            end
                            ) E.MouseButton1Click:Connect(function() G = true j.Text = J.format(f.Value) z.Visible = false j.Visible = true L.Visible = I ~= "" E.Visible = false b(K, {Color = a.StrokeHover}, .12) j:CaptureFocus() task.defer(H, false)
                            end
                            ) j.FocusLost:Connect(function() local c = tonumber(j.Text) G = false j.Visible = false L.Visible = false z.Visible = true E.Visible = true b(K, {Color = a.Stroke}, .2) if c then
                                    f:Set(c)
                                end
                                H(false)
                            end
                            ) O.MouseEnter:Connect(function() if not s then
                                    b(x, {ImageTransparency = .78, Size = UDim2.fromOffset(34, 34)}, .15)
                                end
                            end
                            ) O.MouseLeave:Connect(function() if not s then
                                    b(x, {ImageTransparency = .85, Size = UDim2.fromOffset(28, 28)}, .2)
                                end
                            end
                            )
                            local S = J.snap
                            local function M()
                                return D - o == 0 and 0 or(f.Value - o) / (D - o)
                            end
                            local function P(c, d, a) a = a or Enum.EasingStyle.Linear b(R, {Size = UDim2.new(c, 0, 1, 0)}, d, a) b(A, {Position = UDim2.new(c, 0, .5, 0)}, d, a) b(x, {Position = UDim2.new(c, 0, .5, 0)}, d, a)
                            end
                            local function T(a, b) P(M(), a, b) z.Text = J.format(f.Value) .. I
                            end
                            local function W(b)
                                local a = M()
                                local c = math.max(u.AbsoluteSize.X, 1)
                                local d = (a >= b and 1 or -1) * (5 / c) P(math.clamp(a + d, 0, 1), .22, Enum.EasingStyle.Quint) task.delay(.22, function() if not s then
                                        P(M(), .18, Enum.EasingStyle.Quint)
                                    end
                                end
                                ) z.Text = J.format(f.Value) .. I
                            end
                            local function X() b(A, {Size = UDim2.fromOffset(14, 12)}, .08) b(x, {Size = UDim2.fromOffset(32, 32), ImageTransparency = .78}, .12) task.delay(.1, function() b(A, {Size = UDim2.fromOffset(12, 12)}, .25, Enum.EasingStyle.Quint) b(x, {Size = UDim2.fromOffset(28, 28), ImageTransparency = .85}, .25)
                            end
                            )
                        end
                        function f:Set(a, b) a = S(tonumber(a) or o)
                            if a == f.Value then
                                return
                            end
                            local c = M() f.Value = a
                        ...
                        local function U(a)
                            local b = math.clamp((a - u.AbsolutePosition.X) / u.AbsoluteSize.X, 0, 1) f:Set(o + (D - o) * b)
                        end
                        O.InputBegan:Connect(function(a) if p(a) then
                                s = true b(A, {Size = UDim2.fromOffset(16, 16)}, .15, Enum.EasingStyle.Back) b(x, {Size = UDim2.fromOffset(44, 44), ImageTransparency = .7}, .15) U(r().X)
                            end
                        end
                        ) self.Window:_listen("Changed", function(a) if s and N(a) then
                                U(r().X)
                            end
                        end
                        , f) self.Window:_listen("Ended", function(a) if s and p(a) then
                                s = false b(A, {Size = UDim2.fromOffset(12, 12)}, .2) b(x, {Size = UDim2.fromOffset(28, 28), ImageTransparency = .85}, .2)
                            end
                        end
                        , f) f.Value = S(f.Value) T(0) task.defer(H, true)
                        return n(self, g, f, y, "Slider")
                    end
                    function j:Dropdown(f)
                        local y = "Frame" f = l(f, {Title = "Name", Description = "Desc", CurrentOption = "Default", Value = "Default", MultipleOptions = "Multi", Values = "Options"})
                        if f.Multi and type(f.Default) ~= "table" and f.Default ~= nil then
                            f.Default = {f.Default}
                        elseif not f.Multi and type(f.Default) == "table" then
                                f.Default = f.Default[1]
                            end
                            local r = f.Multi == true
                            local o = f.Options or {}
                            local p, O, v f, p, O, v = z(self, f, {}, y) p.ClipsDescendants = true
                            local I = c("TextButton", {Size = UDim2.new(1, 0, 0, v), BackgroundTransparency = 1, Text = "", AutoButtonColor = false, Parent = p})
                            local S, T = G(I, f.Name or "Dropdown", f.Desc, 180)
                            local q = c(y, {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -10, .5, 0), Size = UDim2.fromOffset(60, s), BackgroundColor3 = a.Surface, BorderSizePixel = 0, ClipsDescendants = true, Parent = I}) e(q, UDim.new(0, 6))
                            local U = h(q)
                            local J = d {Position = UDim2.fromOffset(10, 0), Size = UDim2.new(1, -34, 1, 0), TextColor3 = a.Muted, TextSize = 13, TextTruncate = Enum.TextTruncate.None, ClipsDescendants = true, Parent = q}
                            local V = Z(q, 1, -6)
                            local A, x = d {Size = UDim2.fromOffset(0, s), AutomaticSize = Enum.AutomaticSize.X, TextSize = 13, Visible = false, Parent = q}, ""
                            local function W() A.Text = x
                                if A.TextBounds.X <= 146 then
                                    return x
                                end
                                local a = x
                                while #a > 1 do
                                    a = a:sub(1, -2) A.Text = a .. ".."
                                    if A.TextBounds.X <= 146 then
                                        return a .. ".."
                                    end
                                end
                            ...
                            local function P(c)
                                local a = math.clamp(J.TextBounds.X + 10 + 34, 60, 190) H(S, T, a + 20)
                                if c then
                                    q.Size = UDim2.fromOffset(a, s)
                                else
                                    b(q, {Size = UDim2.fromOffset(a, s)}, .2)
                                end
                            end
                            J:GetPropertyChangedSignal "TextBounds":Connect(function() P(false)
                            end
                            )
                            local K = c(y, {Position = UDim2.new(0, 10, 0, v), Size = UDim2.new(1, -20, 0, 0), BackgroundTransparency = 1, Parent = p}) c("UIListLayout", {SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 4), Parent = K})
                            local g = {Open = false}
                            local j = {}
                            local m, B = {}, ""
                            local X = f.SearchAfter or 6
                            local t = c(y, {Size = UDim2.new(1, 0, 0, L), BackgroundColor3 = a.Surface, BackgroundTransparency = 1, BorderSizePixel = 0, LayoutOrder = 0, Visible = false, Parent = K}) e(t, UDim.new(0, 6))
                            local Y = h(t, a.Stroke, 1)
                            local C = c("TextBox", {Position = UDim2.fromOffset(12, 0), Size = UDim2.new(1, -20, 1, 0), BackgroundTransparency = 1, Text = "", PlaceholderText = "Search", PlaceholderColor3 = a.Muted, TextColor3 = a.Text, TextSize = 13, FontFace = i.Regular, TextXAlignment = Enum.TextXAlignment.Left, ClearTextOnFocus = false, TextTransparency = 1, Parent = t})
                            local function Q(a)
                                return B == "" or string.find(string.lower(tostring(a)), B, 1, true) ~= nil
                            end
                            if r then
                                for b, a in ipairs(f.Default or {}) do
                                    j[a] = true
                                end
                            elseif f.Default ~= nil then
                                ...
                                local function E()
                                    ...
                                    J.Text = W()
                                    for e, d in pairs(m) do
                                        local c = j[e] == true
                                        if d.On ~= c then
                                            d.On = c b(d.Label, {TextColor3 = c and a.Text or a.Muted}, .15)
                                            if g.Open then
                                                b(d.Check, {ImageTransparency = c and 0 or 1}, .15) b(d.CheckScale, {Scale = c and 1 or .6}, c and .3 or .15, c and Enum.EasingStyle.Back or Enum.EasingStyle.Quint)
                                            end
                                        end
                                    end
                                end
                                ...
                                local function F(c) g.Open = c t.Visible = #o > X
                                    if not c then
                                        B = "" C.Text = "" M()
                                    end
                                    b(p, {Size = UDim2.new(1, 0, 0, c and N() or v)}, .3, Enum.EasingStyle.Quint) b(t, {BackgroundTransparency = c and 0 or 1}, .2) b(Y, {Transparency = c and 0 or 1}, .2) b(C, {TextTransparency = c and 0 or 1}, .2) V:Set(c) b(U, {Color = c and a.StrokeHover or a.Stroke}, .2)
                                    local function d(d)
                                        if not d.Stroke then
                                            d.Stroke = h(d.Frame, a.Stroke, 1)
                                        end
                                        local e = c and d.On b(d.Check, {ImageTransparency = e and 0 or 1}, .18) d.CheckScale.Scale = e and 1 or .6 b(d.Label, {TextTransparency = c and 0 or 1}, .18) b(d.Stroke, {Transparency = c and 0 or 1}, .18) b(d.Frame, {BackgroundTransparency = c and 0 or 1}, .18)
                                    end
                                    if c then
                                        local a = (g._openGeneration or 0) + 1 g._openGeneration = a task.spawn(function() local b = true for f, e in ipairs(o) do
                                                local c = m[e] if c and c.Frame.Visible then
                                                    if not b then
                                                        task.wait(.025) if g._openGeneration ~= a or not g.Open then
                                                            return
                                                        end
                                                    end
                                                    b = false d(c)
                                        ...
                                        local b = (g._openGeneration or 0) + 1 g._openGeneration = b
                                        local a = {}
                                        ...
                                        task.spawn(function() for c = #a, 1, -1 do
                                                d(a[c]) if c > 1 then
                                                    task.wait(.015) if g._openGeneration ~= b or g.Open then
                                                        return
                                                    end
                                                end
                                            end
                                ...
                                local function R()
                                    ...
                                    for n, g in ipairs(o) do
                                        ...
                                        local h = c("TextButton", {Size = UDim2.new(1, 0, 0, L), BackgroundColor3 = a.Surface, BackgroundTransparency = 1, Text = "", AutoButtonColor = false, LayoutOrder = n, Parent = K}) e(h, UDim.new(0, 6))
                                        local i = c("ImageLabel", {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -10, .5, 0), Size = UDim2.fromOffset(14, 14), BackgroundTransparency = 1, ImageColor3 = a.Accent, ImageTransparency = 1, ScaleType = Enum.ScaleType.Fit, Parent = h}) u(i, "check")
                                        local p = c("UIScale", {Scale = .6, Parent = i})
                                        local l = d {Position = UDim2.fromOffset(12, -1), Size = UDim2.new(1, -36, 1, 0), Text = tostring(g), TextSize = 13, TextColor3 = a.Muted, TextTransparency = 1, Parent = h}
                                        h.MouseEnter:Connect(function() b(l, {TextColor3 = a.Text}, .15) local c = m[g] if c and c.Stroke then
                                                b(c.Stroke, {Color = a.StrokeHover}, .12)
                                            end
                                        end
                                        ) h.MouseLeave:Connect(function() b(l, {TextColor3 = j[g] and a.Text or a.Muted}, .2) local c = m[g] if c and c.Stroke then
                                                b(c.Stroke, {Color = a.Stroke}, .2)
                                            end
                                        end
                                        ) h.MouseButton1Click:Connect(function() if j[g] then
                                                j[g] = nil
                                            else
                                                if not r then
                                                    j = {}
                                            ...
                                            E() k(f.Callback, D()) if not r and j[g] then
                                                F(false)
                                            end
                                        end
                                        ) m[g] = {Frame = h, Label = l, Check = i, CheckScale = p, Stroke = nil, On = nil}
                                    end
                                    M()
                                    if g.Open then
                                ...
                                function g:Set(a, b) j = {}
                                    ...
                                    function g:SetOpen(a) F(a == true)
                                    end
                                    I.MouseButton1Click:Connect(function() F(not g.Open)
                                    end
                                    ) C:GetPropertyChangedSignal "Text":Connect(function() B = string.lower(C.Text) M() if g.Open then
                                            b(p, {Size = UDim2.new(1, 0, 0, N())}, .2, Enum.EasingStyle.Quint)
                                        end
                                    end
                                    ) R() E() task.defer(P, true)
                                    return n(self, f, g, p, "Dropdown")
                                end
                                function j:Input(f)
                                    local l, p, t, q, r f, l, p, t, q, r = z(self, f, {Title = "Name", Description = "Desc", PlaceholderText = "Placeholder", CurrentValue = "Default", Value = "Default"}, "Frame", 160, "Input")
                                    local g = c("Frame", {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -10, .5, 0), Size = UDim2.fromOffset(170, 30), BackgroundColor3 = a.Surface, BorderSizePixel = 0, Parent = l}) e(g, UDim.new(0, 6))
                                    local s = h(g)
                                    local m = f.Icon
                                    if m then
                                        y(g, m, a.Muted, UDim2.new(0, 8, .5, 0))
                                    end
                                    local d = c("TextBox", {Position = UDim2.fromOffset(m and 30 or 8, 0), Size = UDim2.new(1, m and -38 or -16, 1, 0), BackgroundTransparency = 1, Text = f.Default or "", PlaceholderText = f.Placeholder or "", PlaceholderColor3 = a.Muted, TextColor3 = a.Text, TextSize = 14, FontFace = i.Regular, TextXAlignment = Enum.TextXAlignment.Left, ClearTextOnFocus = false, TextTruncate = Enum.TextTruncate.None, ClipsDescendants = true, Parent = g}) g.ClipsDescendants = true
                                    local o = false
                                    local u = (m and 30 or 8) + 8
                                    local function j(f)
                                        local h = l.AbsoluteSize.X / self.Window.Scale.Scale
                                        ...
                                        local a = math.clamp(e + u + 12, 90, c) + (o and 8 or 0) a = math.min(a, c + 8) H(q, r, a + 20)
                                        if f then
                                            g.Size = UDim2.fromOffset(a, 30)
                                        else
                                            b(g, {Size = UDim2.fromOffset(a, 30)}, .18)
                                        end
                                    end
                                    l:GetPropertyChangedSignal "AbsoluteSize":Connect(function() j(true)
                                    end
                                    ) d:GetPropertyChangedSignal "Text":Connect(function() j(false)
                                    end
                                    ) d:GetPropertyChangedSignal "TextBounds":Connect(function() j(false)
                                    end
                                    ) task.defer(j, true) d.Focused:Connect(function() o = true b(s, {Color = a.StrokeHover}, .15) j(false)
                                    end
                                    ) d.FocusLost:Connect(function(c) o = false b(s, {Color = a.Stroke}, .15) j(false) if f.Numeric then
                                            local a = tonumber(d.Text) if not a then
                                                d.Text = "" return
                                            end
                                        end
                                        k(f.Callback, d.Text, c)
                                    end
                                    )
                                    return n(self, f, {Set = function(b, a) d.Text = tostring(a) w(p)
                                        end
                                        , Get = function() return d.Text
                                        end
                                    }, l, "Input")
                                end
                                function j:Keybind(g)
                                    local o, p, u, q, r g, o, p, u, q, r = z(self, g, {Title = "Name", Description = "Desc", CurrentKeybind = "Default", Value = "Default"}, "Frame", 110, "Keybind")
                                    if type(g.Default) == "string" then
                                        g.Default = Enum.KeyCode[g.Default]
                                    end
                                    local i = c("TextButton", {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -10, .5, 0), Size = UDim2.fromOffset(44, s), BackgroundColor3 = a.Surface, BorderSizePixel = 0, Text = "", AutoButtonColor = false, ClipsDescendants = true, Parent = o}) e(i, UDim.new(0, 6))
                                    local v = h(i)
                                    local j = d {Size = UDim2.new(1, 0, 1, 0), TextSize = 13, TextColor3 = a.Muted, TextXAlignment = Enum.TextXAlignment.Center, TextTruncate = Enum.TextTruncate.None, Parent = i}
                                    local f = {Value = g.Default, Listening = false}
                                    local function t(c)
                                        local a = math.max(j.TextBounds.X + 20, m and 44 or 36) H(q, r, a + 20)
                                        if c then
                                            i.Size = UDim2.fromOffset(a, s)
                                        else
                                            b(i, {Size = UDim2.fromOffset(a, s)}, .2)
                                        end
                                    end
                                    j:GetPropertyChangedSignal "TextBounds":Connect(function() t(false)
                                    end
                                    )
                                    local function l() j.Text = f.Listening and "..." or P(f.Value) b(v, {Color = f.Listening and a.StrokeHover or a.Stroke}, .15) b(j, {TextColor3 = f.Listening and a.Accent or a.Muted}, .15)
                                    end
                                    function f:Set(a, b)
                                        local c = f.Listening f.Value = a f.Listening = false l()
                                        if not c then
                                            w(p)
                                        end
                                        if not b then
                                    ...
                                    i.MouseButton1Click:Connect(function() f.Listening = not f.Listening l()
                                    end
                                    ) self.Window:_listen("Began", function(a, b) if a.UserInputType ~= Enum.UserInputType.Keyboard then
                                            return
                                        end
                                        if f.Listening then
                                            self.Window._consumedKey = a.KeyCode self.Window._consumedAt = os.clock() if a.KeyCode == Enum.KeyCode.Escape then
                                                f.Listening = false l()
                                            else
                                                f:Set(a.KeyCode)
                                            end
                                        ...
                                        if not b and f.Value ~= nil and a.KeyCode == f.Value then
                                            k(g.Callback, a.KeyCode)
                                        end
                                    end
                                    , f) l() task.defer(t, true)
                                    function f:Get()
                                        return f.Value
                                    end
                                    return n(self, g, f, o, "Keybind")
                                end
                                function j:ColorPicker(j)
                                    local D, l, E, F = "Default", "Frame", "TextButton", "UIGradient"
                                    local m, K, u j, m, K, u = z(self, j, {Title = "Name", Description = "Desc", Color = D, CurrentValue = D, Value = D}, l) m.ClipsDescendants = true
                                    local A = c(E, {Size = UDim2.new(1, 0, 0, u), BackgroundTransparency = 1, Text = "", AutoButtonColor = false, Parent = m}) G(A, j.Name or "Color", j.Desc, 90)
                                    local H = c(l, {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -34, .5, 0), Size = UDim2.fromOffset(36, 20), BorderSizePixel = 0, Parent = A}) e(H, UDim.new(0, 6)) h(H, a.Stroke)
                                    local S = Z(A, 1, -12)
                                    local o = c(l, {Position = UDim2.fromOffset(14, u + 2), Size = UDim2.new(1, -28, 0, 156), BackgroundTransparency = 1, Visible = false, Parent = m})
                                    local g = c(E, {Size = UDim2.new(1, -30, 0, 110), BackgroundColor3 = Color3.new(1, 1, 1), BorderSizePixel = 0, Text = "", AutoButtonColor = false, ClipsDescendants = true, Parent = o}) e(g, UDim.new(0, 6))
                                    local T = c(F, {Color = ColorSequence.new(Color3.new(1, 1, 1), Color3.new(1, 0, 0)), Parent = g})
                                    local U = c(l, {Size = UDim2.fromScale(1, 1), BackgroundColor3 = Color3.new(0, 0, 0), BorderSizePixel = 0, Parent = g}) c(F, {Transparency = NumberSequence.new {NumberSequenceKeypoint.new(0, 1), NumberSequenceKeypoint.new(1, 0)}, Rotation = 90, Parent = U})
                                    local v = c(l, {AnchorPoint = Vector2.new(.5, .5), Size = UDim2.fromOffset(10, 10), BackgroundTransparency = 1, ZIndex = 3, Parent = g}) e(v, UDim.new(1, 0)) h(v, Color3.new(1, 1, 1), 0, 2)
                                    local q = c(E, {AnchorPoint = Vector2.new(1, 0), Position = UDim2.new(1, 0, 0, 0), Size = UDim2.fromOffset(14, 110), BorderSizePixel = 0, Text = "", AutoButtonColor = false, Parent = o}) e(q, UDim.new(0, 6)) c(F, {Color = ColorSequence.new {ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)), ColorSequenceKeypoint.new(.16666666666666666, Color3.fromRGB(255, 255, 0)), ColorSequenceKeypoint.new(.3333333333333333, Color3.fromRGB(0, 255, 0)), ColorSequenceKeypoint.new(.5, Color3.fromRGB(0, 255, 255)), ColorSequenceKeypoint.new(.6666666666666666, Color3.fromRGB(0, 0, 255)), ColorSequenceKeypoint.new(.8333333333333334, Color3.fromRGB(255, 0, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 0))}, Rotation = 90, Parent = q})
                                    local x = c(l, {AnchorPoint = Vector2.new(.5, .5), Position = UDim2.new(.5, 0, 0, 0), Size = UDim2.fromOffset(18, 5), BackgroundColor3 = Color3.new(1, 1, 1), BorderSizePixel = 0, ZIndex = 3, Parent = q}) e(x, UDim.new(1, 0)) h(x, a.AccentDark, .4)
                                    local I = c(l, {Position = UDim2.fromOffset(6, 122), Size = UDim2.fromOffset(118, 28), BackgroundColor3 = a.Surface, BorderSizePixel = 0, Parent = o}) e(I, UDim.new(0, 6))
                                    local L = h(I)
                                    local s = c("TextBox", {Position = UDim2.fromOffset(14, 0), Size = UDim2.new(1, -24, 1, 0), BackgroundTransparency = 1, Text = "", TextTruncate = Enum.TextTruncate.None, ClipsDescendants = false, TextColor3 = a.Text, TextSize = 13, FontFace = i.Regular, TextXAlignment = Enum.TextXAlignment.Left, ClearTextOnFocus = false, Parent = I})
                                    local V = d {Position = UDim2.fromOffset(134, 122), Size = UDim2.new(1, -134, 0, 28), TextXAlignment = Enum.TextXAlignment.Right, TextSize = 13, FontFace = i.Regular, TextColor3 = a.Muted, Parent = o}
                                    local f = {Open = false}
                                    local y, B, C = Color3.toHSV(j.Default or a.Accent)
                                    local t
                                    local function M(a)
                                        return string.format("#%02X%02X%02X", math.floor(a.R * 255 + .5), math.floor(a.G * 255 + .5), math.floor(a.B * 255 + .5))
                                    end
                                    local function O(c)
                                        local a = Color3.fromHSV(y, B, C) f.Value = a H.BackgroundColor3 = a T.Color = ColorSequence.new(Color3.new(1, 1, 1), Color3.fromHSV(y, 1, 1)) b(v, {Position = UDim2.fromScale(B, 1 - C)}, c, Enum.EasingStyle.Linear) b(x, {Position = UDim2.new(.5, 0, y, 0)}, c, Enum.EasingStyle.Linear)
                                        if not s:IsFocused() then
                                            s.Text = M(a)
                                        end
                                        V.Text = string.format("RGB %d, %d, %d", math.floor(a.R * 255 + .5), math.floor(a.G * 255 + .5), math.floor(a.B * 255 + .5))
                                    end
                                    local function J(a, b) O(a)
                                        if not b then
                                            k(j.Callback, f.Value)
                                        end
                                    end
                                    function f:Set(a, b) y, B, C = Color3.toHSV(a) J(.25, b) w(K)
                                    end
                                    function f:Get()
                                        return f.Value
                                    end
                                    local function P(a) f.Open = a b(m, {Size = UDim2.new(1, 0, 0, a and u + 168 or u)}, .35, Enum.EasingStyle.Quint) S:Set(a)
                                        if a then
                                            o.Visible = true
                                        else
                                            task.delay(.35, function() if not f.Open then
                                                    o.Visible = false
                                                end
                                            end
                                            )
                                    ...
                                    function f:SetOpen(a) P(a == true)
                                    end
                                    A.MouseButton1Click:Connect(function() P(not f.Open)
                                    end
                                    )
                                    local function Q(a) B = math.clamp((a.X - g.AbsolutePosition.X) / g.AbsoluteSize.X, 0, 1) C = 1 - math.clamp((a.Y - g.AbsolutePosition.Y) / g.AbsoluteSize.Y, 0, 1) J(.04)
                                    end
                                    local function R(a) y = math.clamp((a.Y - q.AbsolutePosition.Y) / q.AbsoluteSize.Y, 0, .999) J(.04)
                                    end
                                    g.InputBegan:Connect(function(a) if p(a) then
                                            t = "sv" b(v, {Size = UDim2.fromOffset(14, 14)}, .15, Enum.EasingStyle.Back) Q(r())
                                        end
                                    end
                                    ) q.InputBegan:Connect(function(a) if p(a) then
                                            t = "hue" b(x, {Size = UDim2.fromOffset(20, 7)}, .15, Enum.EasingStyle.Back) R(r())
                                        end
                                    end
                                    ) self.Window:_listen("Changed", function(b) if not t or not N(b) then
                                            return
                                        end
                                        local a = r() if t == "sv" then
                                            Q(a)
                                        else
                                            R(a)
                                        end
                                    end
                                    , f) self.Window:_listen("Ended", function(a) if t and p(a) then
                                            t = nil b(v, {Size = UDim2.fromOffset(10, 10)}, .2) b(x, {Size = UDim2.fromOffset(18, 5)}, .2)
                                        end
                                    end
                                    , f) s.Focused:Connect(function() b(L, {Color = a.StrokeHover}, .15)
                                    end
                                    ) s.FocusLost:Connect(function() b(L, {Color = a.Stroke}, .15) local c, d, e = s.Text:match "^%s*#?(%x%x)(%x%x)(%x%x)%s*$" if c then
                                            f:Set(Color3.fromRGB(tonumber(c, 16), tonumber(d, 16), tonumber(e, 16)))
                                        else
                                            s.Text = M(f.Value)
                                        end
                                    end
                                    ) O(0)
                                    return n(self, j, f, m, "ColorPicker")
                                end
                                function j:Stepper(g)
                                    local o, t, J, u, v g, o, t, J, u, v = z(self, g, {Title = "Name", Description = "Desc", CurrentValue = "Default", Value = "Default", Increment = "Step"}, "Frame", 150, "Stepper")
                                    local l = g.Min or 0
                                    local q = g.Max or 100
                                    local x = g.Step or 1
                                    local K = g.Suffix or ""
                                    local y = aa(l, q, x)
                                    local j = c("Frame", {AnchorPoint = Vector2.new(1, .5), Position = UDim2.new(1, -10, .5, 0), Size = UDim2.fromOffset(0, s), AutomaticSize = Enum.AutomaticSize.X, BackgroundColor3 = a.Surface, BorderSizePixel = 0, Parent = o}) e(j, UDim.new(0, 6))
                                    local A = h(j) c("UIListLayout", {FillDirection = Enum.FillDirection.Horizontal, SortOrder = Enum.SortOrder.LayoutOrder, VerticalAlignment = Enum.VerticalAlignment.Center, Parent = j})
                                    local function B(e, f)
                                        local d = c("TextButton", {Size = UDim2.fromOffset(s, s), BackgroundTransparency = 1, Text = e, TextColor3 = a.Muted, TextSize = 18, FontFace = i.Medium, AutoButtonColor = false, LayoutOrder = f, Parent = j}) d.MouseEnter:Connect(function() b(d, {TextColor3 = a.Accent}, .12)
                                        end
                                        ) d.MouseLeave:Connect(function() b(d, {TextColor3 = a.Muted}, .2)
                                        end
                                        )
                                        return d
                                    end
                                    local C = B("−", 1)
                                    local m = d {Size = UDim2.new(0, 30, 1, 0), TextSize = 13, TextColor3 = a.Accent, TextXAlignment = Enum.TextXAlignment.Center, TextTruncate = Enum.TextTruncate.None, LayoutOrder = 2, Parent = j}
                                    local D = B("+", 3)
                                    local function E(c)
                                        local a = math.max(m.TextBounds.X + 12, 30)
                                        if c then
                                            m.Size = UDim2.new(0, a, 1, 0)
                                        else
                                            b(m, {Size = UDim2.new(0, a, 1, 0)}, .2)
                                        end
                                    end
                                    m:GetPropertyChangedSignal "TextBounds":Connect(function() E(false)
                                    end
                                    ) j:GetPropertyChangedSignal "AbsoluteSize":Connect(function() H(u, v, j.AbsoluteSize.X / self.Window.Scale.Scale + 20)
                                    end
                                    )
                                    local f = {Value = math.clamp(g.Default or l, l, q)}
                                    local L, r = y.snap, false
                                    local function F() m.Text = y.format(f.Value) .. K b(C, {TextTransparency = f.Value <= l and .6 or 0}, .15) b(D, {TextTransparency = f.Value >= q and .6 or 0}, .15)
                                    end
                                    function f:Set(a, b) a = L(tonumber(a) or l)
                                        if a == f.Value then
                                            return
                                        end
                                        f.Value = a F()
                                    ...
                                    local function G(c) r = true f:Set(f.Value + c * x) r = false b(A, {Color = a.StrokeHover}, .08) task.delay(.12, function() b(A, {Color = a.Stroke}, .2)
                                    end
                                    )
                                end
                                local function I(b, c)
                                    local a = false b.InputBegan:Connect(function(b) if not p(b) then
                                            return
                                        end
                                        a = true G(c) task.delay(.4, function() while a do
                                                G(c) task.wait(.07)
                                            end
                                        end
                                        )
                                    end
                                    ) b.InputEnded:Connect(function(b) if p(b) then
                                            a = false
                                        end
                                    end
                                    ) b.MouseLeave:Connect(function() a = false
                                    end
                                    )
                                end
                                I(C, -1) I(D, 1) F() task.defer(E, true)
                                return n(self, g, f, o, "Stepper")
                            end
                            function j:Progress(f) f = l(f, {Title = "Name", Description = "Desc", CurrentValue = "Default", Value = "Default"})
                                local h, s = B(self, "Frame", f.Desc and v + 10 or K + 10, f) F(h, s)
                                local j = f.Desc and(v - 38) / 2 - 2 or 12 d {Position = UDim2.fromOffset(14, j), Size = UDim2.new(1, -110, 0, 18), Text = f.Name or "Progress", Parent = h}
                                if f.Desc then
                                    d {Position = UDim2.fromOffset(14, j + 20), Size = UDim2.new(1, -110, 0, 17), Text = f.Desc, TextSize = 13, FontFace = i.Regular, TextColor3 = a.Muted, Parent = h}
                                end
                                local o = d {AnchorPoint = Vector2.new(1, 0), Position = UDim2.new(1, -14, 0, j), Size = UDim2.fromOffset(90, 18), TextXAlignment = Enum.TextXAlignment.Right, TextSize = 13, TextColor3 = a.Accent, Parent = h}
                                local p = c("Frame", {Position = UDim2.new(0, 14, 1, -16), Size = UDim2.new(1, -28, 0, 5), BackgroundColor3 = a.Surface3, BorderSizePixel = 0, Parent = h}) e(p, UDim.new(1, 0))
                                local m = c("Frame", {Size = UDim2.new(0, 0, 1, 0), BackgroundColor3 = f.Color or a.Accent, BorderSizePixel = 0, Parent = p}) e(m, UDim.new(1, 0))
                                local g = {Value = math.clamp(f.Default or 0, 0, 1)}
                                local q = f.Format
                                local function r(c)
                                    local a = g.Value b(m, {Size = UDim2.new(a, 0, 1, 0)}, c, Enum.EasingStyle.Quint)
                                    if type(q) == "function" then
                                            o.Text = tostring(q(a))
                                        else
                                            o.Text = string.format("%d%%", math.floor(a * 100 + .5))
                                        end
                                    end
                                    function g:Set(a, b) a = math.clamp(tonumber(a) or 0, 0, 1)
                                        if a == g.Value then
                                            return
                                        end
                                        g.Value = a r(.35)
                                    ...
                                    function g:SetColor(a) m.BackgroundColor3 = a
                                    end
                                    r(0)
                                    return n(self, f, g, h, "Progress")
                                end
                                function j:ConfigManager(d) d = l(d, {})
                                    local a = self.Window
                                    local b = {}
                                    self:Section(d.Name or "Configs")
                                    local e = self:Input {Name = "Config name", Placeholder = a.ConfigName, Callback =
                                        function(a, c)
                                            if c and #a > 0 then
                                                b:Save(a)
                                            end
                                    ...
                                    local c = self:Dropdown {Name = "Saved configs", Options = a:ListConfigs(), Default = a.ConfigName, Callback =
                                        function(a)
                                            if a then
                                                e:Set(a)
                                            end
                                    ...
                                    function b:Refresh() c:Refresh(a:ListConfigs(), true)
                                    end
                                    function b:Save(d) d = d or c:Get() or a.ConfigName
                                        local e, f = a:SaveConfig(d) b:Refresh() c:Set(d, true) a:Notify {Title = e and "Config saved" or "Save failed", Content = e and d or tostring(f), Type = e and "Success" or "Error", Duration = 3}
                                    end
                                    function b:Load(b) b = b or c:Get()
                                        if not b then
                                            return
                                        end
                                        local d, e = a:LoadConfig(b) a:Notify {Title = d and "Config loaded" or "Load failed", Content = d and b or tostring(e), Type = d and "Success" or "Error", Duration = 3}
                                    end
                                    function b:Delete(d) d = d or c:Get()
                                        if not d then
                                            return
                                        end
                                        local e, f = a:DeleteConfig(d) b:Refresh() a:Notify {Title = e and "Config deleted" or "Delete failed", Content = e and d or tostring(f), Type = e and "Info" or "Error", Duration = 3}
                                    end
                                    self:Button {Name = "Save", Desc = "Writes every flagged element to the selected name", Icon = "save", Style = "Primary", Callback =
                                        function()
                                            local a = e:Get() b:Save(#a > 0 and a or nil)
                                        end
                                    }
                                    self:Button {Name = "Load", Icon = "folder-open", Callback =
                                        function() b:Load()
                                        end
                                    }
                                    self:Button {Name = "Delete", Icon = "trash-2", Callback =
                                        function()
                                            local d = c:Get()
                                            if not d then
                                                return
                                            end
                                            a:Confirm {Title = "Delete config", Content = "Remove " .. d .. "? This cannot be undone.", Icon = "trash-2", ConfirmText = "Delete", Callback =
                                                function() b:Delete(d)
                                                end
                                            }
                                        end
                                    }
                                    self:Toggle {Name = "Auto save", Desc = "Save whenever a flagged element changes", Default = a._autoSaveEnabled, Callback =
                                        function(b) a._autoSaveEnabled = b
                                        end
                                    }
                                    return b
                                end
                                for a, b in pairs(table.clone(j)) do
                                    ...
                                    local function aj()
                                        local a pcall(function() if typeof(identifyexecutor) == "function" then
                                                a = (identifyexecutor())
                                            elseif typeof(getexecutorname) == "function" then
                                                ...
                                                return U:IsStudio() and "Studio" or "Unknown"
                                            end
                                            local function ak()
                                                local b, a = pcall(function() return game:GetService "MarketplaceService":GetProductInfo(game.PlaceId)
                                                end
                                                )
                                                if b and type(a) == "table" and a.Name then
                                                    return a.Name
                                                end
                                                return "Unknown game"
                                            end
                                            local al = {US = "United States", GB = "United Kingdom", DE = "Germany", FR = "France", NL = "Netherlands", SG = "Singapore", JP = "Japan", AU = "Australia", BR = "Brazil", IN = "India", HK = "Hong Kong", CA = "Canada"}
                                            local function am(a) task.spawn(function() local b = request or http_request or syn and syn.request or http and http.request local c if type(b) == "function" then
                                                    pcall(function() local a = b {Url = "https://ipinfo.io/json", Method = "GET"}
                                                        local d = type(a) == "table" and(a.Body or a.body) or nil if type(d) == "string" then
                                                            local a = C:JSONDecode(d) if type(a) == "table" and a.country then
                                                                local b = al[a.country] or a.country c = a.city and a.city .. ", " .. b or b
                                                            end
                                                        end
                                                    end
                                                    )
                                        ...
                                        local an = {Success = a.Success, Warning = a.Warning, Error = a.Error}
                                        local g = {}
                                        g.__index = g
                                        function f.Window(ab, k)
                                            local G, p, H, L, I, A = "AirflowUI", "Frame", "CanvasGroup", "UIListLayout", "AbsoluteSize", "table" k = l(k, {Name = "Title", LoadingSubtitle = "Subtitle", ToggleUIKeybind = "Keybind"})
                                            ...
                                            local W = B "Render" table.insert(j._connections, U.RenderStepped:Connect(function(a) W(a) for c, b in ipairs(j._frameSteps) do
                                                    b(a)
                                                end
                                            end
                                            )) table.insert(j._connections, q.InputBegan:Connect(B "Began")) table.insert(j._connections, q.InputChanged:Connect(B "Changed")) table.insert(j._connections, q.InputEnded:Connect(B "Ended"))
                                            local s = c("ScreenGui", {Name = k.Name or G, IgnoreGuiInset = true, ResetOnSpawn = false, DisplayOrder = 999, ZIndexBehavior = Enum.ZIndexBehavior.Sibling}) j.Gui = s
                                            ...
                                            d {Position = UDim2.fromOffset(60, 45), Size = UDim2.new(1, -70, 0, 14), Text = k.Subtitle or "", TextSize = 13, FontFace = i.Regular, TextColor3 = a.Muted, Parent = J}
                                            local v = c("ScrollingFrame", {Name = "Tabs", Position = UDim2.fromOffset(0, 80), Size = UDim2.new(1, 0, 1, -116), BackgroundTransparency = 1, BorderSizePixel = 0, ScrollBarThickness = 0, AutomaticCanvasSize = Enum.AutomaticSize.Y, CanvasSize = UDim2.new(), Parent = C}) j.TabList = v o(v, 16, 16, 4, 4) c(L, {SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 4), Parent = v})
                                            local D = c(p, {AnchorPoint = Vector2.new(0, .5), Position = UDim2.fromOffset(6, 0), Size = UDim2.fromOffset(3, 18), BackgroundColor3 = a.Accent, BorderSizePixel = 0, Visible = false, ZIndex = 2, Parent = C}) e(D, UDim.new(1, 0)) j.Indicator = D
                                            local R = v.CanvasPosition.Y table.insert(j._frameSteps, function() local b = v.CanvasPosition.Y if b == R or not j.CurrentTab or not j._introDone then
                                                    return
                                                end
                                                R = b local a = j:_indicatorY(j.CurrentTab) local c = v.Position.Y.Offset local d = c + v.AbsoluteSize.Y / j.Scale.Scale D.Visible = a > c and a < d D.Position = UDim2.fromOffset(6, a)
                                            end
                                            )
                                            local S = c(p, {Position = UDim2.new(0, 22, 1, -36), Size = UDim2.new(1, -44, 0, 22), BackgroundTransparency = 1, Parent = C})
                                            local y = c("TextButton", {Size = UDim2.fromOffset(0, 22), AutomaticSize = Enum.AutomaticSize.X, BackgroundColor3 = a.Surface, BorderSizePixel = 0, Text = "", AutoButtonColor = false, Parent = S}) e(y, UDim.new(0, 5)) h(y) o(y, 7, 7)
                                            local Y = d {Size = UDim2.new(0, 0, 1, 0), AutomaticSize = Enum.AutomaticSize.X, Text = P(N), TextSize = 11, TextColor3 = a.Muted, TextTruncate = Enum.TextTruncate.None, Parent = y}
                                            j._keyChipLabel = Y
                                            local _rebind = false y.MouseButton1Click:Connect(function() if _rebind then
                                                    return
                                                end
                                                _rebind = true Y.Text = "..." Y.TextColor3 = a.Accent local c; c = q.InputBegan:Connect(function(inp) if inp.UserInputType ~= Enum.UserInputType.Keyboard then
                                                        return
                                                    end
                                                    if inp.KeyCode == Enum.KeyCode.Escape then
                                                        Y.Text = P(j.Keybind) Y.TextColor3 = a.Muted _rebind = false c:Disconnect() return
                                                    end
                                                    j:SetKeybind(inp.KeyCode) Y.TextColor3 = a.Muted _rebind = false c:Disconnect() j:Notify {Title = "Menu bind", Content = "Set to " .. P(inp.KeyCode), Duration = 2}
                                                end
                                                )
                                            end
                                            )
                                            local Z = d {Size = UDim2.new(1, 0, 1, 0), Text = m and "or tap the pill" or "to hide", TextSize = 12, FontFace = i.Regular, TextColor3 = a.Muted, Parent = S}
                                            local function T() Z.Position = UDim2.fromOffset(y.AbsoluteSize.X / j.Scale.Scale + 8, 0)
                                            end
                                            y:GetPropertyChangedSignal(I):Connect(T) task.defer(T)
                                            local E = c(p, {Name = "Content", Position = UDim2.fromOffset(171, 0), Size = UDim2.new(1, -171, 1, 0), BackgroundTransparency = 1, ClipsDescendants = true, Parent = n}) j.Content = E j._outLayer = c(H, {Name = "TransitionOut", Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Visible = false, ZIndex = 2, Parent = E}) j._inLayer = c(H, {Name = "TransitionIn", Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Visible = false, ZIndex = 3, Parent = E})
                                            local w = c("TextButton", {AnchorPoint = Vector2.new(1, 0), Position = UDim2.new(1, -14, 0, 14), Size = UDim2.fromOffset(34, 34), BackgroundColor3 = a.Surface2, BackgroundTransparency = 1, Text = "×", TextColor3 = a.Muted, TextSize = 28, FontFace = i.Bold, AutoButtonColor = false, ZIndex = 5, Parent = E}) o(w, 0, 0, 1, 0) e(w, UDim.new(0, 8)) w.MouseEnter:Connect(function() b(w, {BackgroundTransparency = 0, TextColor3 = a.Text}, .15)
                                            end
                                            ) w.MouseLeave:Connect(function() b(w, {BackgroundTransparency = 1, TextColor3 = a.Muted}, .2)
                                            end
                                            ...
                                            if type(F) == A and F.Enabled ~= false then
                                                ...
                                                j.ConfigFolder = G j.ConfigName = "default" j._autoSaveEnabled = false
                                            end
                                            table.insert(j._connections, q.InputBegan:Connect(function(a, b) if b then
                                                    return
                                                end
                                                if a.UserInputType == Enum.UserInputType.Keyboard and a.KeyCode == j.Keybind then
                                                    task.defer(function() local b = j._consumedKey == a.KeyCode and os.clock() - (j._consumedAt or 0) < .2 j._consumedKey = nil if not b and not j._destroyed then
                                                            j:Toggle(not j.Open)
                                                        end
                                                    end
                                                    )
                                            ...
                                            -- Watermark (theme-matched)
                                            do
                                                local wmTitle = k.Watermark or k.Name or "AirFlow"
                                                local wmSub = k.WatermarkSub or "LeftAlt · toggle"
                                                local W = c("Frame", {Name = "Watermark", AnchorPoint = Vector2.new(0, 0), Position = UDim2.fromOffset(14, 14), Size = UDim2.fromOffset(0, 0), AutomaticSize = Enum.AutomaticSize.XY, BackgroundColor3 = a.Background, BorderSizePixel = 0, ZIndex = 50, Parent = s})
                                                e(W, UDim.new(0, 8))
                                                h(W, a.Stroke, 0, 1)
                                                local accent = c("Frame", {Size = UDim2.new(0, 3, 1, 0), BackgroundColor3 = a.Accent, BorderSizePixel = 0, ZIndex = 51, Parent = W})
                                                e(accent, UDim.new(0, 2))
                                                local inner = c("Frame", {Position = UDim2.fromOffset(10, 0), Size = UDim2.fromOffset(0, 0), AutomaticSize = Enum.AutomaticSize.XY, BackgroundTransparency = 1, ZIndex = 51, Parent = W})
                                                o(inner, 8, 12, 6, 6)
                                                c("UIListLayout", {SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 1), Parent = inner})
                                                local t1 = d {Size = UDim2.fromOffset(0, 16), AutomaticSize = Enum.AutomaticSize.X, Text = tostring(wmTitle), TextSize = 13, FontFace = i.Medium, TextColor3 = a.Text, TextTruncate = Enum.TextTruncate.None, LayoutOrder = 1, ZIndex = 52, Parent = inner}
                                                local t2 = d {Size = UDim2.fromOffset(0, 14), AutomaticSize = Enum.AutomaticSize.X, Text = tostring(wmSub), TextSize = 11, FontFace = i.Regular, TextColor3 = a.Muted, TextTruncate = Enum.TextTruncate.None, LayoutOrder = 2, ZIndex = 52, Parent = inner}
                                                j.Watermark = W
                                                j.WatermarkTitle = t1
                                                j.WatermarkSub = t2
                                                function j:SetWatermark(title, sub)
                                                    if title ~= nil and j.WatermarkTitle then
                                                        j.WatermarkTitle.Text = tostring(title)
                                                    end
                                                    if sub ~= nil and j.WatermarkSub then
                                                        j.WatermarkSub.Text = tostring(sub)
                                                    end
                                                end
                                                function j:SetWatermarkVisible(v)
                                                    if j.Watermark then
                                                        j.Watermark.Visible = v ~= false
                                                    end
                                                end
                                                if k.Watermark == false then
                                                    W.Visible = false
                                                end
                                            end
                                                                        ...
                                                                        local function d(b)
                                                                            for c, b in ipairs(b:GetChildren()) do
                                                                                ...
                                                                                function g:SetKeybind(a)
                                                                                    ...
                                                                                    if self.WatermarkSub then
                                                                                        self.WatermarkSub.Text = P(a) .. " · toggle"
                                                                                    end
                                                                                end
                                                                                function g:Notify(f)
                                                                                    ...
                                                                                    local B = h(g, a.Stroke) M(g) x(g, UDim2.fromOffset(260, 120), UDim2.new(1, -10, 0, -10), .86, 90)
