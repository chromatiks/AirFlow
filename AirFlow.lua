                                ...
                                for a, b in pairs(table.clone(j)) do
                                    ...
                                    local function aj()
                                        ...
                                        function f.Window(ab, k)
                                            ...
                                            local V = k.Size or UDim2.fromOffset(640, 480)
                                            local N = k.Keybind or Enum.KeyCode.RightControl
                                            ...
                                            local y = c(p, {Size = UDim2.fromOffset(0, 22), AutomaticSize = Enum.AutomaticSize.X, BackgroundColor3 = a.Surface, BorderSizePixel = 0, Parent = S}) e(y, UDim.new(0, 5)) h(y) o(y, 7, 7)
                                            ...
                                            ) s.Parent = k.Parent or ag() O.Scale = .9 n.GroupTransparency = 1 Q.ImageTransparency = 1 j.BodyStroke.Transparency = 1 z.Visible = false j:_fitToScreen(true) table.insert(j._connections, s:GetPropertyChangedSignal(I):Connect(function() j:_fitToScreen() j:_clampToScreen()
                                            end
                                            ))
                                                                        ...
                                                                        local function ac(c)
                                                                            ...
                                                                            local function d(b)
                                                                                for c, b in ipairs(b:GetChildren()) do
                                                                                    ...
                                                                                    function g:SetKeybind(a) self.Keybind = a self._keyChipLabel.Text = P(a)
                                                                                    end
                                                                                    function g:Notify(f)
